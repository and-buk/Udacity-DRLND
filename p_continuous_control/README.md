...
For this project, we will work with the [Reacher](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#reacher) environment and with an amended **Deep Deterministic Policy Gradients (DDPG)** algorithm. 
...
For this project, we can use one of two separate versions of the Unity environment:
...
2. Download the environment from one of the links below. Select the environment that matches your operating system:
