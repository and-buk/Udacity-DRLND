...
We will train a DDQN agent to navigate (and collect bananas!) in a large, square world.  
...
2. Place the file in folder with other repository files, and unzip (or decompress) the file.
