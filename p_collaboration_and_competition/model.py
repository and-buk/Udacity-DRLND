...
class Critic(nn.Module):
    ...
    def __init__(self, 
        ...
        self.fc1 = nn.Linear(state_size, fc1_units)
        self.do1 = nn.Dropout(p=0.1) # Dropout Layer
#         self.relu1 = nn.ReLU()
