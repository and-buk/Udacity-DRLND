...
- `MADDPG.py`: A MultiAgent class to provide DDPG agents learning via interaction in a shared environment  
- `model.py`: Implementation of actor and critic neural networks 
- `Tennis.ipynb`: The code to explore the environment and train the agents
